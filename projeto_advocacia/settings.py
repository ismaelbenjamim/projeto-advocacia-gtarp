...
ADMINS = [
    ("""Admin""", 'ismaelbenjamim15@hotmail.com'),
]
...
INSTALLED_APPS = [
    ...
    # Own Apps
    'projeto_advocacia.core.apps.CoreConfig',
...
ROOT_URLCONF = 'projeto_advocacia.urls'
...
WSGI_APPLICATION = 'projeto_advocacia.wsgi.application'
