...
class Cliente(models.Model):
    ...
    identidade = models.CharField('identidade', max_length=10, null=True, blank=True)
...
class Usuario(AbstractUser):
    ...
    identidade = models.CharField('Identidade', max_length=10)
    celular = models.CharField('Celular', max_length=10, null=True, blank=True)
    oab = models.CharField('OAB', max_length=250, blank=True, null=True)
